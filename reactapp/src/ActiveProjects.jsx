    ...
    <div className="dashboard-inner" style={{paddingTop: '750px'}}>
      <div className="content" style={{marginTop: '0px', paddingTop: '30px'}}>
        ...
        <section className="stats-cards">
          <div className="card">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" style={{marginLeft: "150px", backgroundColor:"#03e9f4", borderRadius:"4px", padding:"20px"}} className='iconshover'>
