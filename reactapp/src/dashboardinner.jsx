      ...
      <div className="content">
        ...
        <section className="stats-cards">
          ...
          <div className="card" onClick={() => navigate('/ActiveProjects')} style={{cursor: 'pointer'}}>
           <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="16px" fill="#000000" style={{marginLeft: "105px", backgroundColor:"#03e9f4", borderRadius:"5px", padding:"20px"} } className='iconshover'>
          ...
          <div className="card" onClick={() => navigate('/DepartmentGrowthDashboard')} style={{cursor: 'pointer'}}>
           <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000" style={{marginLeft: "105px" , backgroundColor:"#03e9f4", borderRadius:"5px", padding:"20px"}} className='iconshover'>
